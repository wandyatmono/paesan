...
```bash
wandyatmono@devenvo:~/Projects/its/02.development/00.paesan/apps$ npm create svelte@latest paesan
...
wandyatmono@devenvo:~/Projects/its/02.development/00.paesan/apps$ cd paesan
wandyatmono@devenvo:~/Projects/its/02.development/00.paesan/apps/paesan$ npm install
...
wandyatmono@devenvo:~/Projects/its/02.development/00.paesan/apps/paesan$ git init && git add -A && git commit -m "Initial commit"
...
wandyatmono@devenvo:~/Projects/its/02.development/00.paesan/apps/paesan$ git branch -M master
wandyatmono@devenvo:~/Projects/its/02.development/00.paesan/apps/paesan$ git remote add origin https://github.com/wandyatmono/paesan.git
wandyatmono@devenvo:~/Projects/its/02.development/00.paesan/apps/paesan$ git push -u origin master
